...
import type { Beneficiary, PrepaidAmountOption } from "@/features/mobile-prepaid/types";
...
export const MOCK_BENEFICIARIES: Beneficiary[] = [
  { id: "ben-1", name: "Emma", phoneNumber: "+8564757899", avatarUrl: undefined },
  { id: "ben-2", name: "Justin", phoneNumber: "+8217654321", avatarUrl: undefined },
];

export const MOCK_PREPAID_AMOUNTS: PrepaidAmountOption[] = [
  { label: "$10", value: 1000 },
  { label: "$20", value: 2000 },
  { label: "$30", value: 3000 },
];
